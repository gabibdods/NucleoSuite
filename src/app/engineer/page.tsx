                    ...
                    <table ref={tableRef} className="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="circuit"><img src="https://flagcdn.com/w40/bh.png" alt="Bahrain Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                ...
                                <td className="circuit"><img src="https://flagcdn.com/w40/sa.png" alt="Saudi Arabia Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/au.png" alt="Australia Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                ...
                                <td className="circuit"><img src="https://flagcdn.com/w40/jp.png" alt="Japan Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/cn.png" alt="China Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/us.png" alt="Miami" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/sm.png" alt="San Marino Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/mc.png" alt="Monaco Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                                <td className="aero">50-50</td>
                                <td className="differential">100-15-100</td>
                                <td className="suspgeom">L-L-L-L</td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/ca.png" alt="Canada Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/es.png" alt="Spain Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/at.png" alt="Austria Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/gb.png" alt="Great Britain Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/hu.png" alt="Hungary Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                                <td className="aero">50-50</td>
                                <td className="differential">100-15q / 20r-100</td>
                                <td className="suspgeom">L-L-.02-L</td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/be.png" alt="Belgium Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/nl.png" alt="Netherlands Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/it.png" alt="Italy Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/az.png" alt="Azerbaijan Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/sg.png" alt="Singapore Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                                <td className="aero">50-50</td>
                                <td className="differential">100-20q / 25r-100</td>
                                <td className="suspgeom">L-L-.05-L</td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/us.png" alt="Austin Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/mx.png" alt="Mexico Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/br.png" alt="Brazil Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/us.png" alt="Las Vegas Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/qa.png" alt="Qatar Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                                <td className="aero">50-50</td>
                                <td className="differential">100-15q / 20r-100</td>
                                <td className="suspgeom">L-L-.05-L</td>
                            ...
                            <tr>
                                <td className="direction">ACW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/ae.png" alt="UAE Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                            ...
                            <tr>
                                <td className="direction">CW</td>
                                <td className="circuit"><img src="https://flagcdn.com/w40/pt.png" alt="Portugal Flag" style={{ width: '20px', height: '15px', marginRight: '8px', verticalAlign: 'middle' }}/></td>
                ...
                <div ref={containerRef} className="troubleshooting-section">
                    <table ref={tableRef} className="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>no ERS</th>
                                <td>For Q, mostly M and OVR. HTL for the long straights.<br></br>M for the twisty sections, and OVR out of slow corners / short straights.<br></br>For R, don't be scared to turn off the ERS for some periods,<br></br>as upshifting with no ERS will kick-start the recharge process.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
