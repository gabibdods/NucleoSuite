...
export default function Page() {
    ...
    useEffect(() => {
        ...
        (row as any)._clickListener = clickListener;
        });
        return () => {
        rows.forEach(row => {
            const clickListener = (row as any)._clickListener;
            if (clickListener) {
        ...
        <div>
            <table ref={tableRef} className="my-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Car Height</td>
                        <td>Min, 2 to 3 ticks above 0. Can slightly raise for rake (more rotation) but test to make sure it's better</td>
                    </tr>
                    <tr>
